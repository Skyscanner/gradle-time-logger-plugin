...
package net.skyscanner.hive.gradletimelogger.report.console
...
val consoleReporterFactory: ReporterFactory = { logger, _ ->
    { processedReport: ProcessedReport ->
        logger.lifecycle(processedReport.toString())
    }
}
